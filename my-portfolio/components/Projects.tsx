      ...
      <AnimatePresence>
        {selectedProject && (
          ...
          >
            ...
            >
              <div className="p-8">
                <div className="relative z-10 flex flex-wrap mt-20 items-center justify-between mb-6">
                ...
                <div className="mt-8 pt-6 border-t border-tech-border">
                  <div className="relative z-10 flex flex-wrap mt-20 items-center gap-4">
                    <div className="relative z-10 flex flex-wrap mt-20 flex-wrap gap-2">
